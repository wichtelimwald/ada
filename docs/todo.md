...
- [ ] Measure representative Memory retrieval quality/scale before adding FTS/vector/graph/ReMe/LangMem/Hindsight or another derived runtime; any added dependency must pass its own license/security/platform review.
