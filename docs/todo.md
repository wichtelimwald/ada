...
- [ ] Keep `learning/` out of indefinite Git/backup history by default, or implement bounded history retention that actually purges expired evidence copies before real household Memory.
