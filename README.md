...
| Development Memory history | Ada-owned file adapter using a separately installed Git CLI | Git is GPLv2 and not vendored by Ada; proposed by draft ADR-0010 in PR #41 |
