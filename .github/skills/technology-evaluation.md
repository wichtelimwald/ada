...
5. Review license, governance, maintenance, security history, and distribution implications.
6. Document data flows and trust boundaries.
7. Score only criteria agreed for this decision; do not invent weights to force a preferred result.
8. Prototype only the unknowns that materially affect the decision.
9. Record the final choice and consequences in an ADR.
